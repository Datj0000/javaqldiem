...
public class JHocKy extends JPanel {

    public ButtonCustom btnAdd, btnEdit, btnDelete;
    public JTextField txtMaHocKy, txtTenHocKy, txtSearch;
    public JTable jTable;
    public ComboboxCustom cboNamHoc;
    ...
    public void FormInput() {
        ...
        Menu.customCombobox(jPanel, lblNamHoc, cboNamHoc, "Năm học: ");
        cboNamHoc.setPreferredSize(new Dimension(220, 25));
        detailsPane.add(jPanel, gbc);
        gbc.gridy++;
        JPanel jPanel1 = new JPanel();
        Menu.customTextField(jPanel1, lblMaHocKy, txtMaHocKy, "Mã học kỳ: ");
        detailsPane.add(jPanel1, gbc);
        gbc.gridy++;
        JPanel jPanel2 = new JPanel();
        Menu.customTextField(jPanel2, lblTenHocKy, txtTenHocKy, "Tên học kỳ: ");
    ...
    public void TableView() {
        ...
        //Table
        String ColumnName[] = {"STT", "Mã học kỳ", "Tên học kỳ"};
        Object[][] data = {};
    ...
    public void DataTable(ModelHocKy model) {
    ...
    public void DataCboNamHo(CbModelNamHoc model) {
