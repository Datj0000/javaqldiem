...
public class JKhoi extends JPanel {

    public ButtonCustom btnAdd, btnEdit, btnDelete;
    public JTextField txtMaKhoi, txtTenKhoi, txtSearch;
    ...
    public void FormInput() {
        ...
        gbc.gridy = 1;
        //Input
        JLabel lblMaKhoi = new JLabel();
        JLabel lblTenKhoi = new JLabel();
        txtMaKhoi = new JTextField(18);
        txtMaKhoi.setEnabled(false);
        txtTenKhoi = new JTextField(18);
        JPanel jPanel = new JPanel();
        Menu.customTextField(jPanel, lblMaKhoi, txtMaKhoi, "Mã khối: ");
        detailsPane.add(jPanel, gbc);
        gbc.gridy++;
        JPanel jPanel2 = new JPanel();
        Menu.customTextField(jPanel2, lblTenKhoi, txtTenKhoi, "Tên khối: ");
    ...
    public void TableView() {
        ...
        //Table
        String ColumnName[] = {"STT", "Mã khối", "Tên khối"};
        Object[][] data = {};
    ...
    public void DataTable(ModelKhoi model) {
