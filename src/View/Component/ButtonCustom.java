        ...
        if (mousePressed == true) {
            ...
            if (iskAllowTab()) {
                ...
                for (int i = 0; i < comp.length; i++) {
                    if (comp[i] instanceof ButtonCustom) {

                        ((ButtonCustom) comp[i]).setSelected(false);
                        ((ButtonCustom) comp[i]).setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, kIndicatorColor));
                    }
                }
