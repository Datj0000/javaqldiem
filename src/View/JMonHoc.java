...
public class JMonHoc extends JPanel {

    public ButtonCustom btnAdd, btnEdit, btnDelete;
    public JTextField txtMaMonHoc, txtTenMonHoc, txtSearch;
    ...
    public void FormInput() {
        ...
        Menu.customTextField(jPanel2, lblTenMonHoc, txtTenMonHoc, "Tên môn học: ");
    ...
    public void TableView() {
        ...
        //Table
        String ColumnName[] = {"STT", "Mã môn học", "Tên môn học"};
        Object[][] data = {};
    ...
    public void DataTable(ModelMonHoc model) {
